...
int main() {
	...
	do{
		...
		switch(choice){
						...
						case 2:
						{
							if(s.getName()!=" " && s.getRollNumber()!=0 &&  s.getMarks()!=0 && s.getGrade()!=0 ){
								cout <<"Name:"<<s.getName()<<endl;
								cout <<"Roll Number:"<<s.getRollNumber()<<endl;
								cout <<"Marks:"<<s.getMarks()<<endl;
								cout <<"Grade:"<<s.getGrade()<<endl;
							}else{
								cout<<"Please Add data first because there is no data to display!"<<endl;
							}
							break;
						}
						case 3:
						{	int marks;
							cout<<"Enter Marks:\n";
							cin>>marks;
							cout<<s.calculateGrade(marks)<<endl;
							break;
						}
						case 4:{
							cout<<"Exiting the program.Thank You! See Again!"<<endl;
							break;
						}
						default:
									cout<<"Invalid choice!";
